#!/bin/bash
# Developers : ALIF FUSOBAR - @Xcod3bughunt3r
# Sindy-xFiDos - Adalah Script Bash Sederhana Untuk Keamanan System Server Dari Serangan DDoS.
...
# Dear Sindy : Daun tak butuh warna untuk membuat embun jatuh cinta, walaupun embun tau daun tak pernah menginginkan dia. Begitu pula aku, tak butuh alasan untuk mencintaimu dalam diam walapun aku tau itu akan menyakiti diriku sendiri. :(
